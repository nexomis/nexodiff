...
`https://www.uniprot.org/uniprot/?query=organism:%22homo%20sapiens%22&format=tab&force=true&columns=id,reviewed,protein%20names,genes,database(GeneID),annotation%20score&sort=score&compress=yes`
...
Annotation score with the following format `X ou of 5`, X being an integer
